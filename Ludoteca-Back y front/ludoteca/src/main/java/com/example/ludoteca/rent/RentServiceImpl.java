...
public class RentServiceImpl implements RentService {
     ...
     *
     * @param dto
     * Método que guarda alquileres de jegos en la base de datos
     */
    @Override
    public void save(RentDto dto) {
        ...
        System.out.printf("%b %b %b %b \n ",rentedGameDate,countRentalsDays, customerRentals,rangeDate);
    ...
    public Boolean filterGameByDate(RentDto dto, Long gameId){
        ...
        if(rents==0){
            System.out.println("entra en el true ----------------------->"+"------------>"+this.rentRepository.count(gamesRented) );
            bandera= true; //es decir el juego no esta alquilado dentro de esos dias
        }else{
